...
class rvSPModel : public rvWeapon {
public:

	CLASS_PROTOTYPE(rvSPModel);
...
private:
	...
	CLASS_STATES_PROTOTYPE(rvSPModel);
};

CLASS_DECLARATION(rvWeapon, rvSPModel)
END_CLASS
...
================
*/
void rvSPModel::Save(idSaveGame* savefile) const {
...
================
*/
void rvSPModel::Restore(idRestoreGame* savefile) {
...
/*
================
rvSPModel::CancelGuide
================
*/
void rvSPModel::CancelGuide(void) {
	if (zoomGui && guideEnt) {
...
/*
================
rvSPModel::UpdateGuideStatus
================
*/
void rvSPModel::UpdateGuideStatus(float range) {
...
/*
================
rvSPModel::OnLaunchProjectile
================
*/
void rvSPModel::OnLaunchProjectile(idProjectile* proj) {
...
================
*/
bool rvSPModel::DrumSpin(int speed, int blendFrames) {
...
CLASS_STATES_DECLARATION(rvSPModel)
STATE("Raise", rvSPModel::State_Raise)
STATE("Lower", rvSPModel::State_Lower)
STATE("Idle", rvSPModel::State_Idle)
STATE("Fire", rvSPModel::State_Fire)
STATE("Reload", rvSPModel::State_Reload)
STATE("DrumSpinDown", rvSPModel::State_DrumSpinDown)
STATE("DrumSpinUp", rvSPModel::State_DrumSpinUp)

STATE("ClaspOpen", rvSPModel::Frame_ClaspOpen)
STATE("ClaspClose", rvSPModel::Frame_ClaspClose)
END_CLASS_STATES

/*
================
rvSPModel::State_Raise

Raise the weapon
================
*/
stateResult_t rvSPModel::State_Raise(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};
...
/*
================
rvSPModel::State_Lower

Lower the weapon
================
*/
stateResult_t rvSPModel::State_Lower(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
		STAGE_WAITRAISE
...
/*
================
rvSPModel::State_Idle

Manage the idle state of the weapon
================
*/
stateResult_t rvSPModel::State_Idle(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};
...
/*
================
rvSPModel::State_Fire

Fire the weapon
================
*/
stateResult_t rvSPModel::State_Fire(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_FIRE,
		STAGE_FIREWAIT,
...
/*
================
rvSPModel::State_Reload
================
*/
stateResult_t rvSPModel::State_Reload(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_RELOAD,
		STAGE_RELOADWAIT,
...
/*
================
rvSPModel::State_DrumSpinUp

Spin the drum from a slow speed to a fast speed
================
*/
stateResult_t rvSPModel::State_DrumSpinUp(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};
...
/*
================
rvSPModel::State_DrumSpinDown

Spin the drum down from a faster speed
================
*/
stateResult_t rvSPModel::State_DrumSpinDown(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};
...
/*
================
rvSPModel::Frame_ClaspOpen

Open the clasp that holds in the clips
================
*/
stateResult_t rvSPModel::Frame_ClaspOpen(const stateParms_t& parms) {
...
================
*/
stateResult_t rvSPModel::Frame_ClaspClose(const stateParms_t& parms) {
	if (mods & NAILGUN_MOD_ROF_AMMO) {
