...
class rvReinfeld : public rvWeapon {
public:

	CLASS_PROTOTYPE(rvReinfeld);
...
private:
	...
	CLASS_STATES_PROTOTYPE(rvReinfeld);
};

CLASS_DECLARATION(rvWeapon, rvReinfeld)
END_CLASS

/*
================
rvReinfeld::rvReinfeld
================
*/
rvReinfeld::rvReinfeld(void) {
}
...
================
*/
void rvReinfeld::Save(idSaveGame* savefile) const {
}
...
================
*/
void rvReinfeld::Restore(idRestoreGame* savefile) {
	hitscans = spawnArgs.GetFloat("hitscans");
}
...
CLASS_STATES_DECLARATION(rvReinfeld)
STATE("Idle", rvReinfeld::State_Idle)
STATE("Fire", rvReinfeld::State_Fire)
STATE("Reload", rvReinfeld::State_Reload)
END_CLASS_STATES

/*
================
rvReinfeld::State_Idle
================
*/
stateResult_t rvReinfeld::State_Idle(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};
...
/*
================
rvReinfeld::State_Fire
================
*/
stateResult_t rvReinfeld::State_Fire(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};
...
/*
================
rvReinfeld::State_Reload
================
*/
stateResult_t rvReinfeld::State_Reload(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
